...
## Sample project: Movie Ticket Booking System

A beginner-friendly sample project has been added in `/movie-ticket-booking` to demonstrate:

- User registration and login
- Movie and show-time selection
- Ticket quantity selection and booking total

To run it locally, open `movie-ticket-booking/index.html` in a browser.
